                        ...
                        <table class="table table-striped table-bordered table-hover dt-responsive" id="sample_1">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-xs-1"> Price/Day </th>
                                    <th class="col-xs-1"> Price/Week </th>
                                    <th class="col-xs-1"> Price/Month </th>
                                    <th class="col-xs-1"> Trip(s) </th>
                                    <th class="col-xs-1"> Total Income </th>
