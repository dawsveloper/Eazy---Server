...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>WTMS | User Login</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Water Treatment Management System " name="description" />
        ...
        <link href="{{ asset('theme/assets/pages/css/login-5.min.css')}}" rel="stylesheet" type="text/css" />
            ...
            <div class="row bs-reset">
                <div class="col-md-6 login-container bs-reset">
                    ...
                    <div class="login-content">
                        <h1>Water Treatment Management System</h1>
                        <p> Inventory system developed by KaryaIn for Gapura Liqua Mandiri. </p>
                        ...
                        <div class="row bs-reset">
                            <div class="col-xs-7 bs-reset">
                                <div class="login-copyright text-right">
                                    <p>Copyright &copy; KaryaIn 2017</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<![endif]-->
        ...
        <script src="{{ asset('theme/assets/global/plugins/backstretch/jquery.backstretch.min.js')}}" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="{{ asset('theme/assets/global/scripts/app.min.js')}}" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="{{ asset('theme/assets/pages/scripts/login-5.min.js')}}" type="text/javascript"></script>
